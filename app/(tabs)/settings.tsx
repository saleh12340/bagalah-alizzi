...
export default function SettingsScreen() {
  ...
  const setNotice = (text: string, type: "success" | "error") => setNoticeState({ text, type });
...
const styles = StyleSheet.create({
  saveButton: { minHeight: 54, borderRadius: 17, alignItems: "center", justifyContent: "center", marginTop: 8 },
  notice: { position: "absolute", left: 16, right: 16, bottom: 18, minHeight: 48, borderRadius: 14, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 8, zIndex: 10000 },
  noticeText: { color: "#fff", fontSize: 13, fontWeight: "800", flex: 1, textAlign: "right" },
